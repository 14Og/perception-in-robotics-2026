Perception in Robotics course, at Skoltech, MS in Data Science, during T3, 2026.
...
> * Teaching Assistant: Anastasiia Archangelskaya
> * Teaching Assistant:  Dmitry Nalbersky
...
For each lecture, all material will be shared with you, mostly though telegram and the repository. These includes the class notes, the handwritten notes as a result of the class and a short seminar we might do in class. We recommend you to print the class notes and we **strongly recommend** to write your own notes on the printed document while following the class.
...
|----------------------|----------------|------------------------------------|
| L1: Expectation      | Tue 3 Feb      | sample mean and cov                |
| L2: Gaussians        | Thu 4 Feb      | Gaussian numerical norm  + Mahal.  |
| L3: Motion models    | Fri 6  Feb     | Nonlinear propagation              |
| L4: Gaussians2       | Tue 10  Feb    | TBD                      |
| L5: KF               | Thu 11  Feb   | 1D KF with breaking example        |
| L6: EKF localization | Fri 13  Feb    | 1D EFK temperature                  |
| L7: PF               | Tue 17  Feb    | Seminar on sampling 1D             |
| L8: SLAM             | Thu 18 Feb     | warping angle                  |
| L10: graphSLAM       | Fri 20  Feb    | TBD                              |
| L9: Visual Keypoints | Tue 24  Feb    | Pair of images Keypoints    |
| L11: Pose SLAM       | Thu 25  Feb    | TBD         |
| Preparation midterm  | Fri 27 Feb     |            |
| Midterm              | Tue 3 March    | 2 hrs                              |
| L12: RBT 2D and 3D   | Thu 4 Mar      | SE2 and SE3 poses         |
| L13: PC aligment     | Fri 6 Mar      | TBD       |
| L14: Mapping         | Tue 10 March   | TBD                                |
| L15: Visual SLAM     | Thu 11 March   | TBD                                |
| Project Pesentation  | Fri 27 March   |                                 |
 ...
 * 12-Feb-2026, PS1: Gaussians and Visualization 
 * 24-Feb-2026, PS2: Localization
 * 12-March-2026, PS3: SLAM
...
## Previous material
For reference, we have previous lecture repositories ([class25](https://github.com/g-ferrer/Perception-in-Robotics-2025)) but there are modifications with respect to the current year.
